...
var implementationType = require('bpmn-js-properties-panel/lib/provider/camunda/parts/implementation/ImplementationType'),
    delegate           = require('./CustomDelegate'),
...
module.exports = function(group, element, bpmnFactory) {
  ...
  var businessObject = getBusinessObject(element),
      ...
      hasExternalSupport = isExternalCapable(getBusinessObject(element));

  // implementation type ////////////////////////////////////

  if(!(javaClass && javaClass.length > 0)) {
